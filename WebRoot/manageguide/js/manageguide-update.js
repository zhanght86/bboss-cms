...
function manageGuideUpdate() {
	...
	if ($("#tdPwControlIndicators_controlType").val() == "-1") {
		$("#tdPwControlIndicators_controlType").focus();
	...
	add_manageguide_form.attr("action", basePath + "/manage_updateManageGuide.action?cache="+ new Date().getTime());
