...
<%@ page import="com.frameworkset.platform.sysmgrcore.manager.db.*,com.frameworkset.platform.sysmgrcore.manager.*,
				com.frameworkset.platform.sysmgrcore.manager.db.CSMenuManagerImpl.ReportMenu,
				com.frameworkset.platform.sysmgrcore.manager.db.CSMenuManagerImpl.ReportMenus"%>
