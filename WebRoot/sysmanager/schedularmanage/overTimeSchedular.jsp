...
<script language="JavaScript">
	...
	function modify(checkName){
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=getModifySchedular&path=overtime";
	...
	function view(checkName){	
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=getSchedularAndRemind&path=overtime";
		document.forms[0].submit();
	}
	function history(checkName){
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=history&path=overtime";
		document.forms[0].submit();
	}
	...
	function dealRecord(checkName,dealType) {
	    if(!validatecheck(checkName))
		{
	    	...
	    	if (dealType==1){
	        	...
	        	if (confirm(outMsg)){
		        	Org.action="../schedularmanage/schManager.do?method=deleteSchedular&path=overtime";
					Org.submit();
			 		return true;
				}
			} 
