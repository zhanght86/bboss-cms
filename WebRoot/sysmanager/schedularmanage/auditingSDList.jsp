...
<html>
	...
	function auditing(checkName){		
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=getAuditingSchedular";
	...
	if(!validatecheck(checkName))
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=getSchedular&path=auditingSDList";
		document.forms[0].submit();
	}
	...
	function dealRecord(checkName,dealType) {
	    if(!validatecheck(checkName))
		{
	    	...
	    	if (dealType==1){
	        	...
	        	if (confirm(outMsg)){
		        	Org.action="../schedularmanage/schManager.do?method=deleteSchedular&path=auditingSDList";
					Org.submit();
			 		return true;
				}
			} 
