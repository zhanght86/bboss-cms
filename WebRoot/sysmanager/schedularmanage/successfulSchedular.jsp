...
<html>
	...
	function modify(checkName){		
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=getModifySchedular&path=success";
	...
	function view(checkName){		
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=getSchedularAndRemind&path=success";
		document.forms[0].submit();
	}
	function history(checkName){
		...
		document.forms[0].action="../schedularmanage/schManager.do?method=history&path=success";
		document.forms[0].submit();
	}
	...
	function dealRecord(checkName,dealType) {
	    if(!validatecheck(checkName))
		{
	    	...
	    	if (dealType==1){
	        	...
	        	if (confirm(outMsg)){
		        	Org.action="../schedularmanage/schManager.do?method=deleteSchedular&path=success";
					Org.submit();
			 		return true;
				}
			} 
