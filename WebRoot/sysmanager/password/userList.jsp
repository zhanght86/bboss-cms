    					...
    					<td>
    						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table2">
    							<tr>
    								...
    								<th>&nbsp;</th>
    								<td>
    									<a href="#" class="bt_1"  name="search"  onclick="queryUser()"><span><pg:message code="sany.pdp.common.operation.search"/></span></a>
    								</td>
    							</tr>
    						</table>
    					</td>
	...
	<div id="changeColor">
		...
		<pg:pager maxPageItems="15" scope="request" data="UserListSn" isList="false">
			...
			<pg:notequal actual="${UserListSn.itemCount}"  value="0">
				...
				<div class="btnarea" >
	 				<a href="#" class="bt_1"  name="but"  onclick="returnUserName()"><span><pg:message code="sany.pdp.common.operation.ok"/></span></a> 
				 <div>
			</pg:notequal>
		</pg:pager>
	</div>
