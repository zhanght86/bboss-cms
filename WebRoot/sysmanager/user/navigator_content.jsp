...
<%@page import="com.frameworkset.platform.sysmgrcore.manager.db.OrgAdministratorImpl"%><%@ include file="../include/global1.jsp"%>
    ...
    <table >
        ...
        <tr><td>
         <tree:tree tree="UserOrg_tree"
    			   ...
    			   <tree:treedata treetype="com.frameworkset.platform.menu.UserOrgTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="机构树"
    	                   expandLevel="1"
