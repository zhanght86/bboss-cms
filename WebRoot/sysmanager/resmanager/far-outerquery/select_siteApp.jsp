...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			...
			if(selectNode==null){
 				W.$.dialog.alert('<pg:message code="sany.pdp.sysmanager.resource.type.siteapp.select"/>'); return;
 			}    
 			var ret ;
    ...
    <table >
        <tr><td>
         <tree:tree tree="selectorgnode"
    			   ...
    			   <tree:treedata treetype="com.frameworkset.platform.sysmgrcore.purviewmanager.menu.SiteAppTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="${rootName}"
    	                   expandLevel="1"
