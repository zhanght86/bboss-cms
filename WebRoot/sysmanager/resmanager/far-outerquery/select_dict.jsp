...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			...
			if(selectNode==null){
 				W.$.dialog.alert('<pg:message code="sany.pdp.sysmanager.resource.type.dict.select"/>'); return;
 			}    
 			var ret ;
...
<div id="contentborder" style="width:100%;height:495;overflow:auto">
    ...
    <table >
    <tr>
    	<td><input name="dictresid" type="radio" value="globaldict:globaldict:global"/><pg:message code="sany.pdp.sysmanager.resource.dict.global"/></td>
    	</tr>
        ...
        <tr><td>
         <tree:tree tree="selectmenunode"
    			   ...
    			   <tree:treedata treetype="com.frameworkset.platform.sysmgrcore.purviewmanager.menu.ResSelectDictTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="${rootName}"
    	                   expandLevel="1"
