...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			selectNode = document.all.orgid;
		
			if(selectNode==null){
 				$.dialog.alert('<pg:message code="sany.pdp.sysmanager.resource.type.org.select"/>'); return;
 			}    
 			var ret ;
...
<div id="contentborder" style="width:100%;height:495;overflow:auto">
    ...
    <table >
    	...
    	<tr>
    	<td><input name="orgid" type="radio" value="orgunit:orgunit:global"/> <pg:message code="sany.pdp.sysmanager.resource.org.global"/></td>
    	</tr>
    	<%} %>
        <tr><td>
