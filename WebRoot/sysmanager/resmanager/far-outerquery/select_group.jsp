...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			...
			if(selectNode==null){
 				W.$.dialog.alert('<pg:message code="sany.pdp.common.operation.select"/>' + "！"); return;
 			}    
 			var ret ;
...
<div id="contentborder" style="width:100%;height:495;overflow:auto">
    ...
    <table >
    <tr>
    	<td><input name="groupresid" type="radio" value="groupmanager:groupmanager:global"/> <pg:message code="sany.pdp.sysmanager.resource.usergroup.global"/></td>
    	</tr>
    </table>
</div>
</body>
