...
<%
	request.setAttribute("rootName", RequestContextUtils.getI18nMessage("sany.pdp.post.tree.name", request));
%>
...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			...
			if(selectNode==null){
 				W.$.dialog.alert('<pg:message code="sany.pdp.sysmanager.resource.type.post.select"/>'); return;
 			}    
 			var ret ;
...
<div id="contentborder" style="width:100%;height:495;overflow:auto">
    ...
    <table >
    <tr>
    	<td><input name="jobresid" type="radio" value="globaljob:globaljob:global"/> <pg:message code="sany.pdp.sysmanager.resource.userpost.global"/></td>
    	</tr>
        ...
        <tr><td>
         <tree:tree tree="selectmenunode"
    			   ...
    			   <tree:treedata treetype="com.frameworkset.platform.sysmgrcore.purviewmanager.menu.ResSelectJobTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="${rootName}"
    	                   expandLevel="1"
