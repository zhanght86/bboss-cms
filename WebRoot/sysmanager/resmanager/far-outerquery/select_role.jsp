...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			...
			if(selectNode==null){
 				$.dialog.alert('<pg:message code="sany.pdp.sysmanager.resource.type.role.select"/>'); return;
 			}    
 			var ret ;
    ...
    <table >
        <tr><td>
         <tree:tree tree="selectrolenode"
    			   ...
    			   <tree:treedata treetype="com.frameworkset.platform.sysmgrcore.purviewmanager.menu.ChargeRoleTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="${rootName}"
    	                   expandLevel="1"
