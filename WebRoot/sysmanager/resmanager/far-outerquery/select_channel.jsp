...
<%
	request.setAttribute("rootName", RequestContextUtils.getI18nMessage("sany.pdp.channel.tree.name", request));
%>
...
<head>
	...
	<script type="text/javascript" language="Javascript">
		...
		function okadd(){	
			...
			if(selectNode==null){
 				W.$.dialog.alert('<pg:message code="sany.pdp.sysmanager.resource.type.channel.select"/>'); return;
 			}    
 			var ret ;
    ...
    <table >
        <tr><td>
         <tree:tree tree="selectorgnode"
    			   ...
    			   <tree:treedata treetype="com.frameworkset.platform.sysmgrcore.purviewmanager.menu.ChannelTree"
    	                   scope="request"
    	                   rootid="0"  
    	                   rootName="${rootName}"
    	                   expandLevel="1"
