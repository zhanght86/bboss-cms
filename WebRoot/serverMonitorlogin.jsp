...
<%
    ...
    if (isCasServer)
    {
        ...
        else
        {
        	...
        	{
            	out.print("系统启用了cas单点登录功能，请在web.xml的CAS Filte中拦截serverMonitorlogin.jsp页面");
            }
            else
            {
...
<form name="loginForm" action="serverMonitorlogin.jsp" method="post"><input type="hidden" name="flag" value="yes">	
   ...
   <TR>
    <TD width="75" height=400 colspan="2"><div align="center">
      <table width="776" height="413" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td background="mq/images/servermonitor.jpg" style="background-repeat:no-repeat"><div align="center">
            <table width="100%" height="410" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
              <input name="subsystem_id" value="trans_server" type="hidden" />
                <td>&nbsp;</td>
                <td height="27"><label>&nbsp;&nbsp;
