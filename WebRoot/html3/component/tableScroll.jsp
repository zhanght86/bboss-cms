...
<!-- <link rel="stylesheet" type="text/css"  href="${pageContext.request.contextPath}html3/component/stylesheet/jscrollpane2.css" />


<script type="text/javascript"   src="${pageContext.request.contextPath}html3/component/js/jquery.mousewheel.js" ></script>
<script type="text/javascript"   src="${pageContext.request.contextPath}html3/component/js/jquery.jscrollpane.min.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}html3/component/js/tableScroll.js"></script>
...
$(document).ready(function() {
	...
	$.sanyTable({
		tableDiv:"#tableTotal",
		tableLeftDiv:"#tableLeft",
		tableRightDiv:"#tableRight",
		fixWidth:280,
		fixRow:1  
    });
	scrollTableColor("tableFixed","tableScroll");
	scrollTableColor("tableScroll","tableFixed");
    $("#tableFixed,#tableScroll").find("tr:even").not($("tr").eq(0)).addClass("table_trColor");
   ...
   <div class="tableOperation">
        ...
        <div class="operation">
            <ul>
               ...
               <li><a  href="#" class="bt_senior_search" onclick="addRow(tableFixed)"><span>新增</span></a></li>
    ...
    <div class="tableLeft" id="tableLeft">
       <table border="0" cellspacing="0" cellpadding="0" class="table_basic table_bline" width="100%"  id="tableFixed">
     
     <tr>
      <th><input id="id616189" value="c7ee2713-cc2b-497a-af02-72078a8334c1" type="checkbox" name="mm"  /></th>
      <th>序号</th>
      <th>票据号码</th>
      <th>操作</th>
     </tr>
     <tr>
       <td><input id="id616189" value="c7ee2713-cc2b-497a-af02-72078a8334c1" type="checkbox" name="mm" /></td>
       <td> 1 </td>
    ...
    <div class="tableRight" id="tableRight" >
      ...
      <table   border="0" cellspacing="0" cellpadding="0" class="table_basic table_bline"  id="tableScroll">
