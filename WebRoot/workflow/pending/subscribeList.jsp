	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="stable" id="subscribeList">
      ...
      <pg:list autosort="false" requestKey="datas" >
   		<tr id="<pg:cell colName="id"/>" >     
                ...
                <td>
                <a href="javascript:void(0)" onclick="confirm(this,'1')" id="<pg:cell colName="id"/>_sub" ><span>订阅</span></a>
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <a href="javascript:void(0)" onclick="confirm(this,'0')" id="<pg:cell colName="id"/>_cancel"><span>取消</span></a>
                </td>
