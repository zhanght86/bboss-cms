	...
	<div data-role="page">
		...
		<div data-role="footer" id="footer" data-position="fixed" data-theme="a">
			...
			<div data-role="navbar">
				<ul>
					<li><a href="#" data-icon="check" id="approve" data-role="button" data-iconpos="right"><pg:message code="sany.gsp.pending.approve.pass" /></a></li>
					<li><a href="#" data-icon="delete" id="reject" data-role="button" data-iconpos="right"><pg:message code="sany.gsp.pending.approve.reject" /></a></li>
				</ul>
			</div>
			<!-- /navbar -->
		</div>
