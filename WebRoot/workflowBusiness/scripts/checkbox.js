...
function getCheckBoxValue(){
  try{
   ...
   for(var i = 0 ; i < arrLength;i++){
    ...
    if(obj.type != null && obj.type != "" && (obj.type.toLowerCase() == "checkbox" ||obj.type.toLowerCase()=="radio")){ //转换为小写然后比较，这样就不区分大小写了
      if(obj.checked){
         checkboxValue +="<span class='md_6 fw'>"+obj.nextSibling.nodeValue+"</span>";
     }
    }
   }
