...
<DIV id=div_top>
 <div id="wrapper" style="border:0;">
  <div class="top_contain">
    ...
    <br /><pg:message code="sany.pdp.module.welcome"/>　，<a class="name" href="#"><%=accesscontroler.getUserName()%></a><span class="cart"><a href="../html2/cart.html">Cart (1)</a></span> <span class="logout">
