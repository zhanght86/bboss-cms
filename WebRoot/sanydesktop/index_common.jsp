...
<div  class="top">
  <div class="logo_top" ><%=AccessControl.getAccessControl().getCurrentSystemName() %></div>
      <div class="right_info">审批事项：<a href="javascript:void(0)" >10</a>条 | 
      通知：<a href="javascript:void(0)" >2</a>条 | </div>
  <div class="info">
    <ul>
...
<pg:true  requestKey="showboot" >
<div class="footer">
  <div class="left_footer"> <a href="ghp/index.html">全球招聘平台</a> | <a href="http://olm.sany.com.cn/SanyOLM/login.do?method=login">在线学习平台</a> | <a href="javascript:void(0)" id="contact">联系我们 </a>| <a href="javascript:void">调查问卷</a> 
  </div>
