...
<BODY>
  <H1 class=h1>
    <div class="fright"><sany:menupath/></div>
    Concrete Pump Trucks</H1>
  <DIV class="rcontent">
    <p class="pic"><img src="${pageContext.request.contextPath}/html2/images/20110630174000529.jpg" width="700" height="220"></p>
    <p>&nbsp;</p>
    <div class="ull">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ptable">
        <tr>
          <td><b>View the model number :</b></td>
          <td>&nbsp;</td>
          <td colspan="3" align="right">Note: Click the model number for details</td>
        </tr>
        <tr class="tr2">
          <td>&nbsp;</td>
          <td><a href="#"><img src="${pageContext.request.contextPath}/html2/images/zxll_en.gif"></a></td>
          <td><a href="#"><img src="${pageContext.request.contextPath}/html2/images/zxxz_en.gif" width="130" height="18"></a></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>25M Concrete Pump Trucks</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="tr2">
          ...
          <td><a href="#"><img src="${pageContext.request.contextPath}/html2/images/zxll_en.gif"></a></td>
          <td><a href="#"><img src="${pageContext.request.contextPath}/html2/images/zxxz_en.gif" width="130" height="18"></a></td>
          <td><a href="#"><img src="${pageContext.request.contextPath}/html2/images/ckxq1_en.gif" width="90" height="18"></a></td>
          <td><a href="#"><img src="${pageContext.request.contextPath}/html2/images/zxgm_en.gif" width="100" height="18"></a></td>
        </tr>
        <tr>
          <td><UL>
            <LI>28M Concrete Pump Trucks</LI>
          </UL></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
