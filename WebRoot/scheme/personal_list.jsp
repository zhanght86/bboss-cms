  ...
  function chucolor(obj){
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			class="Ctable">
			<pg:listdata
				dataInfo="com.frameworkset.platform.integralwarning.scheme.service.UserService"
				keyName="UserService" />
			<!--分页显示开始,分页标签初始化-->
			<pg:pager maxPageItems="5" scope="request" data="UserService"
				isList="false">
				<tr>
					<!--设置分页表头-->
				...
				<pg:list>
					<tr onmousemove="setcolor(this)" onmouseout="chucolor(this)"
						...
						<td height='20' align=left class="t1">
							<pg:cell colName="xm" defaultValue="" />
						</td>
						<td height='20' align=left class="t1" title="<pg:cell colName="remark" defaultValue="" />">
						    <pg:cell colName="id_card" maxlength="22" replace="..." defaultValue="" />
							
						</td>
						<td height='20' align=left class="t1">
							<pg:cell colName="mz" defaultValue="" />
						</td>
						<td height='20' align=left class="t1">
							<pg:cell colName="xb" defaultValue="" />
						</td>
