...
function addScheme() {
	...
	var add_scheme_form = $("#add_scheme_form");
	...
	add_scheme_form.attr("target", "queryList");
	add_scheme_form.attr("action", basePath + "/scheme_insertScheme.action?cache="+ new Date().getTime());
	add_scheme_form.submit();
	parent.closeWindow();
