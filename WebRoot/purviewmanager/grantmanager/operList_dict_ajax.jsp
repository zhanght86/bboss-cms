...
<%
	...
	List hasOper = operManager.getOperResRoleList(role_type,currRoleId,resId,resTypeId);
...
<SCRIPT LANGUAGE="JavaScript"> 
	var ok = <%=isok%>;
	if(ok!=null){
		parent.parent.parent.parent.$.dialog.alert("操作授予成功!",function(){},null,"<pg:message code='sany.pdp.common.alert'/>");
...
function setCheck(currCheck,priority)
{
	...
	function okRecord(dealType) {
		   ...
		   parent.parent.parent.parent.$.dialog.confirm("确认提交吗?",function(){
