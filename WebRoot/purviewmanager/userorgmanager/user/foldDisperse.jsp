...
<%@ page import="org.frameworkset.web.servlet.support.RequestContextUtils,org.frameworkset.event.*,com.frameworkset.platform.security.event.*"%>
...
<script>
	...
	if(<%=state%>){
		...
		parent.alertfun("<pg:message code='sany.pdp.common.operation.fail.nocause'/>","<pg:message code='sany.pdp.common.alert'/>");
