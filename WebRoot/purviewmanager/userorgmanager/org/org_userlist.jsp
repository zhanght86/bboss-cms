...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="javascript">
			...
			<body >
			<div class="titlebox">
					<SPAN class=location>当前机构：<A href="javascript:void(0)"><%=orgpath %></A></SPAN>
			</div>
			<div class="mcontent">
	      ...
	      <tr>
	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table2">
	          ...
	          <tr>
				...
				<td>
		            <a href="javascript:void(0)" class="bt_1" onClick="queryUser()"><span><pg:message code="sany.pdp.common.operation.search"/></span></a>
		            <a href="javascript:void(0)" class="bt_2" onClick="userList.reset()"><span><pg:message code="sany.pdp.common.operation.reset"/></span></a></td>
				</td>
				</tr>				
	          </table>
	          </td>
	...
	<div class="title_box">
		<div class="rightbtn">
			...
			%>
				<a href="javascript:void(0)" class="bt_small" onClick="newUser()"><span><pg:message code="sany.pdp.add.user"/></span></a>
				<a href="javascript:void(0)" class="bt_small" onClick="quiteDelUser()"><span><pg:message code="sany.pdp.delete"/></span></a>
			<%
				}
			%>        						
				<a href="javascript:void(0)" class="bt_small" onClick="orderUser()"><span><pg:message code="sany.pdp.sort.user"/></span></a>
			<%
     						if(accesscontroler.checkPermission("orgunit",
                        		"usermanager", AccessControl.ORGUNIT_RESOURCE)){
     					%>							
				<a href="javascript:void(0)" class="bt_small" onClick="foldUser()"><span><pg:message code="sany.pdp.move.in.user"/></span></a>
				<a href="javascript:void(0)" class="bt_small" onClick="addorg(1)"><span><pg:message code="sany.pdp.move.out.user"/></span></a>
			<%
				}
			%>
				<a href="javascript:void(0)" class="bt_small" onClick="roleUser(1)"><span><pg:message code="sany.pdp.sys.role.authorize"/></span></a>
				<%if(isJobOpen){ %>
				<a href="javascript:void(0)" class="bt_small" onClick="jobUser(1)"><span><pg:message code="sany.pdp.sys.post.authorize"/></span></a>
				<% }%>
			<%
     						if(accesscontroler.checkPermission("orgunit",
                        		"purset", AccessControl.ORGUNIT_RESOURCE)){
     		%>	
				<a href="javascript:void(0)" class="bt_small" onClick="operUser(1)"><span><pg:message code="sany.pdp.sys.purview.authorize"/></span></a>
				<a href="javascript:void(0)" class="bt_small" onClick="purviewReclaimUsers()"><span><pg:message code="sany.pdp.sys.purview.recycle"/></span></a>	
			<%
				}
			%>	
		</div>
