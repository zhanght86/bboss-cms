...
<%
		...
		if(groupId!=null)
		{
			...
			{
				//--
				operContent=RequestContextUtils.getI18nMessage("sany.pdp.groupmanage.add.user", request)+"："
				+userName_log+RequestContextUtils.getI18nMessage("sany.pdp.groupmanage.to.group", request)+"："+groupNames_Log;					
				description="";
			...
			{
				//--
				operContent=RequestContextUtils.getI18nMessage("sany.pdp.groupmanage.delte.user", request)+"："
				+userName_log+RequestContextUtils.getI18nMessage("sany.pdp.groupmanage.from.group", request)+"："+groupNames_Log;					
				description="";
				logManager.log(control.getUserAccount(),operContent,openModle,operSource,description);          
				//--	end	 --
