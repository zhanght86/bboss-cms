		...
		<body>	
			<div id="" align="center">
				...
				<div class="title_box">
					...
					<a href="#" class="bt_small" id="addButton" onclick="addRole();"><span><pg:message code="sany.pdp.groupmanage.add.role"/></span></a>
					<a href="#" class="bt_small" id="addButton" onclick="changeRole();"><span><pg:message code="sany.pdp.groupmanage.correlation.role"/></span></a>
					<a href="#" class="bt_small" id="addButton" onclick="editGroup();"><span><pg:message code="sany.pdp.groupmanage.modify.group"/></span></a>
					<a href="#" class="bt_small" id="addButton" onclick="delGroup();"><span><pg:message code="sany.pdp.groupmanage.delte.group"/></span></a>
					<a href="#" class="bt_small" id="addButton" onclick="lookInfo();"><span><pg:message code="sany.pdp.groupmanage.group.information"/></span></a>
					<a href="#" class="bt_small" id="addButton" onclick="addsonGroup();"><span><pg:message code="sany.pdp.groupmanage.new.child.group"/></span></a>
					<%
