...
<pg:notempty actual="${datas}">
   <pg:pager scope="request"  data="datas" desc="false" isList="false" containerid="detailList" selector="customContent">
	<pg:param name="bm"/>
	...
	<!-- 加入 class="tableOutline" 可控制表格宽度，滚动条展示 -->
		<div class="tableContainer" id='testdiv'>
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="stable" id="demoTable">
        <pg:header>
