...
<div class="comment_title"><div class="comment_num"><a href="#"><font color="blue" ><b>${queryString}</b></font>的搜索结果，检索耗时：<span class="red_num" >${searchTime }</span>秒，共检索出<span class="red_num" >
