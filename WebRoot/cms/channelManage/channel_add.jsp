...
<%
	...
	Channel channel = SiteCacheManager.getInstance().getChannelCacheManager(siteId).getChannel(parentChannelId);
	String parentChannelName =null ;
	...
	{
		parentChannelName =channel.getDisplayName() + "-" +  channel.getName() ;
	}
%>
<html>
<head>
					...
					<tab:tabPane id="foo-channel" tabTitle="基本信息">
						<table width="98%" border="0" cellpadding="3" cellspacing="0" class="Templateedittable">
							...
							<tr>
								...
								<td height="24">
									<textarea rows="10" cols="80" name="channel_desc"></textarea>
								</td>
							</tr>
