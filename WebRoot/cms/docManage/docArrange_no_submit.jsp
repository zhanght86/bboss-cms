...
<%
	...
	logManager.log(accesscontroler.getUserAccount(),"更新置顶文档顺序.频道:【" + site.getName() + " 站点，" + channel.getDisplayName() + " 频道】","文档管理",com.frameworkset.util.StringUtil.getClientIP(request),"");
	/*
	try
	{
		//初始化发布引擎
