	    ...
	    <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td style="background:url(../images/querybox_bg.gif) repeat-x top"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="query_table">
              ...
              <td width="245">              </tr>
              <tr>
				<td height="23" colspan="7">&nbsp; 当前位置:个人工作台 &nbsp;>> &nbsp;发布中文档</td>
			  </tr>
              <tr>
                <td width="87" align="right">文档标题：</td>
                <td width="171" align="left" valign='middle'><input name="docTitle" type="text" size="24"  class="cms_text">                </td>
                <td width="76" align="right">发布人：</td>
                <td width="167" align="left" valign='middle'><input name="publisher" type="text" size="20"  class="cms_text">
              </tr>
