	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="stable" id="tb">
      ...
      <pg:list autosort="false">
   		<tr>
        		...
        		<td><a href="javascript:void(0)" onclick="deleteRecord('<pg:cell colName="id" />')">删除</a></td>
        		<td><a href="javascript:void(0)" onclick="modifyOrIncrementRecord('<pg:cell colName="id" />','modify')">修改</a></td>
        </tr>
	 </pg:list>
    </table>
    </div>
