...
var api = frameElement.api, W = api.opener;
   ...
   function confirm() {	
	   ...
	   if("modify"==type){
		   ...
		   $.ajax({
		 	 	type: "POST",
				url : "pageListSingleModify.page",
				data :{id:id,functionCode:functionCode},
				dataType : 'json',
				async:false,
	...
	<body>
      ...
      <pg:list autosort="false" requestKey="datas">
           <tr style="display: none;">
   		   ...
   		   <tr> 
   		   <td style="display:none">耗费工时(小时)</td>
        		<td style="display:none"><pg:cell colName="timeSpent" /></td>  
			...
			<tr><td>
					<a href="#" class="bt_2"  onclick="confirm()"><span>保存</span>
