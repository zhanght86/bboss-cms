	...
	<div class="mcontent">
		<div class="tabbox" >
			<ul class="tab" id="menu2">
				<li><a href="javascript:void(0)" onclick="setTab(2,0)"><span>应用访问记录</span></a></li>
				<li><a href="javascript:void(0)" onclick="setTab(2,1)"><span>应用访问页面汇总</span></a></li>
				<li><a href="javascript:void(0)" class="current" onclick="setTab(2,2)"><span>应用访问概况</span></a></li>
			</ul>
		</div>
		<div id="main2">
