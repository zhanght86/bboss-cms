 ...
 *
 */
public enum EnumWeiXinErrorCode {
	C1(1, "系统繁忙，此时请开发者稍候再试"),
	C0(0, "请求成功"),
	C40001(40001, "获取access_token时AppSecret错误，或者access_token无效。请开发者认真比对AppSecret的正确性，或查看是否正在为恰当的公众号调用接口"),
	C40002(40002, "不合法的凭证类型"),
	C40003(40003, "不合法的OpenID，请开发者确认OpenID（该用户）是否已关注公众号，或是否是其他公众号的OpenID"),
	C40004(40004, "不合法的媒体文件类型"),
	C40005(40005, "不合法的文件类型"),
	C40006(40006, "不合法的文件大小"),
	C40007(40007, "不合法的媒体文件id"),
	C40008(40008, "不合法的消息类型"),
	C40009(40009, "不合法的图片文件大小"),
	C40010(40010, "不合法的语音文件大小"),
	C40011(40011, "不合法的视频文件大小"),
	C40012(40012, "不合法的缩略图文件大小"),
	C40013(40013, "不合法的AppID，请开发者检查AppID的正确性，避免异常字符，注意大小写"),
	C40014(40014, "不合法的access_token，请开发者认真比对access_token的有效性（如是否过期），或查看是否正在为恰当的公众号调用接口"),
	...
	C40030(40030, "不合法的refresh_token"),
	C40031(40031, "不合法的openid列表"),
	C40032(40032, "不合法的openid列表长度"),
	C40033(40033, "不合法的请求字符，不能包含uxxxx格式的字符"),
	C40035(40035, "不合法的参数"),
	C40038(40038, "不合法的请求格式"),
	C40039(40039, "不合法的URL长度"),
	C40050(40050, "不合法的分组id"),
	C40051(40051, "分组名字不合法"),
	C40117(40117, "分组名字不合法"),
	C40118(40118, "media_id大小不合法"),
	C40119(40119, "button类型错误"),
	C40120(40120, "button类型错误"),
	C40121(40121, "不合法的media_id类型"),
	C40132(40132, "微信号不合法"),
	C40137(40137, "不支持的图片格式"),
	C41001(41001, "缺少access_token参数"),
	C41002(41002, "缺少appid参数"),
	C41003(41003, "缺少refresh_token参数"),
	C41004(41004, "缺少secret参数"),
	C41005(41005, "缺少多媒体文件数据"),
	C41006(41006, "缺少media_id参数"),
	C41007(41007, "缺少子菜单数据"),
	C41008(41008, "缺少oauth code"),
	C41009(41009, "缺少openid"),
	C42001(42001, "access_token超时，请检查access_token的有效期，请参考基础支持-获取access_token中，对access_token的详细机制说明"),
	C42002(42002, "refresh_token超时"),
	C42003(42003, "oauth_code超时"),
	C43001(43001, "需要GET请求"),
	C43002(43002, "需要POST请求"),
	C43003(43003, "需要HTTPS请求"),
	C43004(43004, "需要接收者关注"),
	C43005(43005, "需要好友关系"),
	C44001(44001, "多媒体文件为空"),
	C44002(44002, "POST的数据包为空"),
	...
	C46004(46004, "不存在的用户"),
	C47001(47001, "解析JSON/XML内容错误"),
	C48001(48001, "api功能未授权，请确认公众号已获得该接口，可以在公众平台官网-开发者中心页中查看接口权限"),
	C50001(50001, "用户未授权该api"),
	...
	C61454(61454, "客服帐号名长度超过限制(仅允许10个英文字符，不包括@及@后的公众号的微信号)(invalid kf_acount length)"),
	C61455(61455, "客服帐号名包含非法字符(仅允许英文+数字)(illegal character in kf_account)"),
	C61456(61456, "客服帐号个数超过限制(10个客服账号)(kf_account count exceeded)"),
	C61457(61457, "无效头像文件类型(invalid file type)"),
	C61450(61450, "系统错误(system error)"),
	C61500(61500, "日期格式错误"),
	C61501(61501, "日期范围错误"),
	C9001001(9001001, "POST数据参数不合法"),
	C9001002(9001002, "远端服务不可用"),
	C9001003(9001003, "Ticket不合法"),
	C9001004(9001004, "获取摇周边用户信息失败"),
	C9001005(9001005, "获取商户信息失败"),
	C9001006(9001006, "获取OpenID失败"),
	...
	C9001021(9001021, "已有设备激活率低于50%，不能新增设备"),
	C9001022(9001022, "设备申请数不合法，必须为大于0的数字"),
	C9001023(9001023, "已存在审核中的设备ID申请"),
	C9001024(9001024, "一次查询设备ID数量不能超过50"),
	C9001025(9001025, "设备ID不合法"),
	C9001026(9001026, "页面ID不合法"),
	C9001027(9001027, "页面参数不合法"),
	C9001028(9001028, "一次删除页面ID数量不能超过10"),
	C9001029(9001029, "页面已应用在设备中，请先解除应用关系再删除"),
	C9001030(9001030, "一次查询页面ID数量不能超过50"),
	C9001031(9001031, "时间区间不合法"),
	C9001032(9001032, "保存设备与页面的绑定关系参数错误"),
	C9001033(9001033, "门店ID不合法"),
	C9001034(9001034, "设备备注信息过长"),
	C9001035(9001035, "设备申请参数不合法"),
	C9001036(9001036, "查询起始值begin不合法");
	private static Map<Integer, EnumWeiXinErrorCode> enumFundnamepools = new HashMap<Integer, EnumWeiXinErrorCode>();

	static {
		for (EnumWeiXinErrorCode fundname : EnumWeiXinErrorCode.values()) {
			enumFundnamepools.put(fundname.getCode(), fundname);
		}
	}
	private int code;
	private String name;

	EnumWeiXinErrorCode(int code, String name) {
		this.name = name;
		this.code = code;
	}
	...
	public static EnumWeiXinErrorCode getEnumTradeTypeBycode(int code) {
		if (code < 0) {
			return null;
		}
		return enumFundnamepools.get(code);
	}
