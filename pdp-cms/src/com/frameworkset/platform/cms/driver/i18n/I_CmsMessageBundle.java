 ...
 * <code>{@link com.frameworkset.platform.cms.driver.i18n.A_CmsMessageBundle}</code>. Moreover, the implementation 
 ...
 * 
 * <li>{@link com.frameworkset.platform.cms.driver.i18n.CmsMessages}: This is a fully localized resource bundle, 
 * with a list of keys and a {@link java.util.Locale} to localize these keys. If you have a {@link I_CmsMessageBundle},
 * you can use {@link I_CmsMessageBundle#getBundleName()} to initialize a {@link com.frameworkset.platform.cms.driver.i18n.CmsMessages} instance
 * using {@link com.frameworkset.platform.cms.driver.i18n.CmsMessages#CmsMessages(String, Locale)}.</li>
 * 
 * <li>{@link com.frameworkset.platform.cms.driver.i18n.CmsMessageContainer}: In some circumstances, you do not have a {@link java.util.Locale},
 * but you want to generate a message that contains certain parameters anyway. For example, in the deeper layers of the
 * OpenCms core an issue may be generated, but you do not have a full user context available. The {@link com.frameworkset.platform.cms.driver.i18n.CmsMessageContainer}
 ...
 * is reached.</li>
 * 
 * <li>{@link com.frameworkset.platform.cms.driver.i18n.CmsMultiMessages}: This is a convenience class that contains a set 
 * of {@link com.frameworkset.platform.cms.driver.i18n.CmsMessages}. A key lookup is automatically done in all the {@link com.frameworkset.platform.cms.driver.i18n.CmsMessages} 
 ...
 * @since 6.0.0 
 */
public interface I_CmsMessageBundle extends java.io.Serializable {
