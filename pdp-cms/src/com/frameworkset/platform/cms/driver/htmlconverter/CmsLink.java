...
import com.frameworkset.platform.cms.driver.jsp.CmsRequestUtil;
import com.frameworkset.platform.cms.driver.jsp.CmsXmlPage;
...
public class CmsLink implements java.io.Serializable {
    ...
    public String getSiteRoot() {
        ...
        if (m_internal) {
            m_siteRoot = CMSUtil.getSitePath(m_target);
            return m_siteRoot;
        }
        return null;
    }
