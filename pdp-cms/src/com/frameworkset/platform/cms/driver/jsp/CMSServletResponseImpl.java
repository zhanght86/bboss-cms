 ...
 * @version 1.0
 */
public class CMSServletResponseImpl extends HttpServletResponseWrapper implements java.io.Serializable,CMSServletResponse {
	...
	public CMSServletResponseImpl(HttpServletResponse response,Context context) { 
		super(response);
...
//		this.setCharacterEncoding("GBK");
	...
	public CMSServletResponseImpl(HttpServletResponse response) {
		super(response);
