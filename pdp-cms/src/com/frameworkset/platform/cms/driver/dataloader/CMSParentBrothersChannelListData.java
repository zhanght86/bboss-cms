 ...
 * @version 1.0
 */
public class CMSParentBrothersChannelListData extends CMSBaseListData implements java.io.Serializable {
				...
				if(context != null)
				{
					if(this.site == null)
					{
						ListInfo lstifo = CMSUtil.getCMSDriverConfiguration()
									  .getCMSService()
									  .getChannelManager()
									  .getParentBrotherChannels(super.context.getSiteID(),channel,arg2,arg3);
						return lstifo;
					}
					else
					{
						...
						ListInfo lstifo = CMSUtil.getCMSDriverConfiguration()
									  .getCMSService()
									  .getChannelManager()
									  .getParentBrotherChannels(siteinfo.getSiteId()+"",channel,arg2,arg3);
						return lstifo;
					}
				}
				else
				...
				if(context != null)
				{
					if(this.site == null)
					{
						List published = CMSUtil.getCMSDriverConfiguration()
												.getCMSService()
												.getChannelManager()
												.getParentBrotherChannels(context.getSiteID(),channel,count);
					...
					else
					{
						...
						List published = CMSUtil.getCMSDriverConfiguration()
												.getCMSService()
												.getChannelManager()
												.getParentBrotherChannels(siteinfo.getSiteId() + "",channel,count);
						ListInfo listInfo = new ListInfo();
						listInfo.setDatas(published);
						return listInfo;
					}
