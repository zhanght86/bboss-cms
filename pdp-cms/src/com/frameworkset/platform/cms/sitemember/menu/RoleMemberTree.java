 ...
 * 
 */
public class RoleMemberTree extends COMTree implements java.io.Serializable {
	...
	public boolean setSon(ITreeNode father, int curLevel) {
		...
		try {
			...
			Role role = new Role();
			role.setRoleId(roleID);
			List roleList = roleManager.getRoleList("select * from td_sm_Role r where r.role_Type ='member' and r.remark1='1' or r.remark1='0'  order by r.role_Name");
			if (roleList != null) {
