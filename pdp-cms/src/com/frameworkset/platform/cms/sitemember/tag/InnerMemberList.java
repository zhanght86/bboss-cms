 ...
 *
 */
public class InnerMemberList  extends DataInfoImpl implements java.io.Serializable{
...
//		未登陆天数
		...
		try {
			  //查询条件为空取所有会员信息
			   if((membername==null && realname==null  && address==null && nologin==null )||(address.equals("") && realname.equals("") && membername.equals("")&& nologin.equals(""))){
				   ...
				   String sql ="select a.* from td_sm_user a,TD_SM_USER_ADDONS b" +
      						...
      						" a.user_type = 1 and b.ISPAY='2' order by a.user_REGDATE desc";
			...
			else
			{
          		...
          		sb.append(" u.user_type = 1 and b.ISPAY='2' ");
          		//登陆名
