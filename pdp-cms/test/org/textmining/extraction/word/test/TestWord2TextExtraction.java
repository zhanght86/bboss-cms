...
public class TestWord2TextExtraction
  extends TestWordExtraction
{
  public void testSimple() throws IOException, PasswordProtectedException
  {
    textExtractionTest("./test/text/winword2/simple.doc", "This is a simple test of text extraction for Word documents.");
  }    

  public void testFastSaved() throws IOException, PasswordProtectedException
  {
    textExtractionTest("./test/text/winword2/fastSaved.doc", "This is a simple test of text extraction for Word documents. This document is a fast saved Word document.");
  }
