...
public abstract class TestWordExtraction
  extends TestCase
{
  protected void textExtractionTest(String fileName, String text) throws IOException, PasswordProtectedException
  {
  ...
  protected abstract TextExtractor getTextExtractor(FileInputStream in) throws IOException, PasswordProtectedException;
