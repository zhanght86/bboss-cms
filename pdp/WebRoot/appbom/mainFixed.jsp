...
<link href="${pageContext.request.contextPath}/common/css/superTables.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/common/scripts/superTables.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/html/js/dialog/lhgdialog.js?self=false&skin=sany"></script>
	...
	<body>
		<div class="mcontent">
			...
			<div id="detailList" style="overflow:auto">
...
$(document).ready(function() {
	 bboss.pager.pagerevent = {     
	      afterload:function(opt){   
	    		initTableFn({table:'demoTable',fixedCols:5,div:'testdiv'});   
	  }};  
...
function queryList(){	
	$("#detailList").load("queryListAppBomFixed.page #customContent",function(){initTableFn({table:'demoTable',fixedCols:5,div:'testdiv'}); })
}
...
{	var bm=$("#bm_query").val();
	...
	$("#detailList").load("queryListAppBomFixed.page #customContent",
	{bm:bm,app_name_en: app_name_en,app_name:app_name,soft_level:soft_level,
	state:state,rd_type:rd_type},function(){
	initTableFn({table:'demoTable',fixedCols:5,div:'testdiv'});
	 });
...
{	
	$("#detailList").load("queryListAppBomFixed.page?"+$("#querystring").val()+" #customContent",function(){
	initTableFn({table:'demoTable',fixedCols:5,div:'testdiv'});
	 });
}
function editBom(id){
