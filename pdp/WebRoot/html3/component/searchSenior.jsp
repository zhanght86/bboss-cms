...
<script type="text/javascript" src="${pageContext.request.contextPath}/html3/component/js/seniorSearch.js"></script>
   ...
   <div class="sany_li">
    ...
    <div class="sany_li2">
     ...
     <a  href="#" class="bt_search"  id="search_button" style="margin-left:10px;margin-top:0px;" ><span>查询</span></a>
      ...
      <div id="senior_search_content"  style="display:none"> 
          <div class="sany_li2">
           <span class="sany_li_title">部门：</span>
           <span><input name="" type="text"  class="input1 w450" value="部门" onfocus="this.value=''" onblur="if(this.value==''){this.value='单号'}" /></span>
          </div>
          <div class="sany_li">
           <span class="sany_li_title">部门：</span>
           <span><input name="" type="text"  class="input1" value="部门" onfocus="this.value=''" onblur="if(this.value==''){this.value='单号'}" /></span>
          </div>
            <div class="sany_li2">
           <span class="sany_li_title">部门：</span>
           <span><input name="" type="text"  class="input1 w450" value="部门" onfocus="this.value=''" onblur="if(this.value==''){this.value='单号'}" /></span>
            ...
            <div class="sany_li">
           <span class="sany_li_title">部门：</span>
           <span class="fLeft" ><input name="" type="text"  class="input1" value="部门" onfocus="this.value=''" onblur="if(this.value==''){this.value='单号'}" /></span>
           
          </div>
      </div>
     
      <a   href="javascript:void(0)" class="bt_senior_search" id="senior_search_button"
      style="position:absolute;right:10px;bottom:8px;"><span>高级搜素</span></a>
 ...
 <div class="list_box">
   <div class="tableOperation">
    ...
    <div class="tableTotal" id="tableTotal">
      <table   border="0" cellspacing="0" cellpadding="0" class="table_basic table_bline"  id="table">
              <tr>
