...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/scheme/js/scheme-frame.js">
</script>
		<script type="text/javascript"
...
function clearInfos() {
	...
	tableInfoForm.schemeId.value = "";
	tableInfoForm.schemeName.value = "";
}
function query() {
	var tableInfoForm = document.getElementById("tableInfoForm");
...
function add_scheme() {
	JqueryDialog.Open('新增方案', 'add_scheme.jsp', 1000, 298);
}
			...
			<table width="99%" border="0" cellpadding="0" cellspacing="0" style="margin-top:5px;">
					...
					<td>
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td width="35%">
									<input id="controlCode" class="input_out" name="schemeId"
										type="text"
								...
								<td width="35%">
									<input id="controlName" name="schemeName" type="text"
										class="input_out"
										onfocus="this.className='input_on';this.onmouseout=''"
										onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
										onmousemove="this.className='input_move'"
							...
							--%><tr>
								<td colspan="4" align="center">
									...
									<button type="button" onclick="query()" class="button">
										查询
									</button>
									&nbsp;&nbsp;
									<button type="button" onclick="clearInfos()" class="button">
										清空
									</button>
								</td>
							</tr>
				...
				<tr>
					<td colspan="4" align="right">
						<input name="button" type="button" onclick="add_scheme()"
							class="addbutton1" value="添加" />
						<input name="Submit223" type="button"
							onclick="update_scheme()" class="xbutton1" value="修改" />
						<input name="Submit2222" type="button" onclick="del_scheme()"
