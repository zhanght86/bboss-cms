				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td style="text-align:right">
							<a href="javascript:void(0)" class="bt_1" id="addButton" onclick="javascript:sub()"><span><pg:message code="sany.pdp.common.operation.search"/></span></a>
				<a href="javascript:void(0)" class="bt_2" id="delBatchButton" onclick="javascript:resetSearch()"><span><pg:message code="sany.pdp.common.operation.reset"/></span></a>
						</td>
					</tr>
				</table>
				</td>
