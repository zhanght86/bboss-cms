...
function storeUser()
{
	...
	if (validateForm(UserInfoForm) )
	{
		...
		document.UserInfoForm.action="updateUser.jsp?userId=<%=userId%>";
		...
		<table border="0" cellpadding="0" cellspacing="0" class="table4">
			...
			<tr>						
				...
				<th><pg:message code="sany.pdp.identity.card"/>：</th>
					<td height="25">
					<input type="text" name="userIdcard" value="<pg:cell colName="userIdcard"/>"  cnname="身份证号码" maxlength="18">
				</td>
		   ...
		   <tr><th> <pg:message code="sany.pdp.user.type"/>：</th>
			   ...
			   <td height="25">
					...
					<tr>
						...
						<td height="25">
							<input type="text" name="userBirthday" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="true" value="<pg:cell colName="userBirthday"  defaultValue=""  />"  cnname="生日" >
						</td>
						<th>
		  ...
		  <div class="btnarea">
				<a href="javascript:void(0)" class="bt_1" id="addButton"
					onclick="storeUser()"><span><pg:message code="sany.pdp.common.operation.save"/></span></a> <a
					href="javascript:void(0)" class="bt_2" id="resetButton"
					onclick="reset1()"><span><pg:message code="sany.pdp.common.operation.reset"/></span></a>
					<a href="javascript:void(0)" class="bt_1" 
					onclick="defaultpass()"><span><pg:message code="sany.pdp.reset.password"/></span></a>
					 <a href="javascript:void(0)" class="bt_2" id="resetButton"
					onclick="closeDlg()"><span><pg:message code="sany.pdp.common.operation.exit"/></span></a> <input type="reset"
...
function renewPassword(){
	...
	if(renewPaw == "true"){
		W.$.dialog.alert("<pg:message code='sany.pdp.reset.password.success'/>");
	}
}
</script>
</body> 
