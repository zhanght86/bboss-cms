...
<div class="mcontent">
	...
	<iframe name="orgUserList" id="orgUserList"
		src="org_userlistIframe.jsp?orgId=<%=curOrgId%>" style="width: 100%"
		height="100%" scrolling="auto" frameborder="0" border="0"></iframe>
