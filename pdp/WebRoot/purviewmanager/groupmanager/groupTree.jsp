				...
				<form name="OrgJobForm" action="" method="post">
					<table class="table" width="100%" border="0" cellpadding="0" cellspacing="1">
						<tr class="tr" height=30>
							<td class="td" >
							<td align="center">
									<a href="javascript:void(0)" onclick="findUserGroup()"><pg:message code="sany.pdp.groupmanage.group.query"/></a>
							</td>
							<% 
							...
							%>
								...
								<td align="center">
									<a href="javascript:void(0)" onclick="newFirstGroup()"><pg:message code="sany.pdp.groupmanage.new"/></a>
								</td>
							<% 
								}
							%>
