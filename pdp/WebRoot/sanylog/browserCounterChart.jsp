			...
			<td align="center" >
				...
				<script type="text/javascript">
					var chart = new FusionCharts("fusion/Line.swf", "ChartId", "850", "250", "0", "0");
       				chart.setXMLUrl("<%=request.getContextPath()%>/sanylog/${browserCounterForwordPage}?type=${type}&siteId=${param.siteId}&startTime=${startTime}&endTime=${endTime}");
			...
			<tr>
				<td align="center" colspan="2">
					...
					<script type="text/javascript">
	    				...
	    				chart.setXMLUrl("<%=request.getContextPath()%>/sanylog/${browserTypeForwordPage}?type=${type}&siteId=${param.siteId}&startTime=${startTime}&endTime=${endTime}");
				...
				<td align="center">
					...
					<script type="text/javascript">
						var chart = new FusionCharts("fusion/Pie2D.swf", "ChartId", "600", "250", "0", "0");
	    				chart.setXMLUrl("<%=request.getContextPath()%>/sanylog/${browserIPForwordPage}?type=${type}&siteId=${param.siteId}&startTime=${startTime}&endTime=${endTime}");
