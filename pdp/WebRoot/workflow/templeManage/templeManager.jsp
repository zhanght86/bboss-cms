...
<body>
	<div class="mcontent" style="width:98%;margin:0 auto;overflow:auto;">
		...
		<div id="rightContentDiv">
			...
			<div class="title_box">
				<div class="rightbtn">
					<a href="javascript:void(0)" class="bt_small" id="paramButton"><span>参数管理</span></a>
					<a href="javascript:void(0)" class="bt_small" id="addButton"><span>新增</span></a>
					<a href="javascript:void(0)" class="bt_small" id="delBatchButton"><span>删除</span></a>
				</div>
