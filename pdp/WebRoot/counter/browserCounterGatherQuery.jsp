	...
	//查询浏览统计列表数据
	 function queryList() {	
		...
		var pageURL = $("#pageURL").val();
	   	$("#custombackContainer").load("showPageBrowserCounterGatherList.freepage #customContent", { siteId:siteId, channelId:channelId, docName:docName, pageURL:pageURL }, function(){loadjs()});
	}
