	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="stable" id="tb">
      ...
      <pg:list autosort="false" requestKey="datas">
   		<tr>     
                ...
                <td><a href="javascript:void(0)" onclick="editWorkDate('<pg:cell colName="id"/>')"><span>编辑工作日期</span></a>
                <%-- |&nbsp;&nbsp;<a href="javascript:void(0)" onclick="editWorkTime('<pg:cell colName="id"/>')"><span>编辑工作时间</span></a> --%>
                </td>
        </tr>
	 </pg:list>
    </table>
