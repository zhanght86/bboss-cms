...
<SCRIPT language="javascript">
	...
	function advance_newDict(){
		...
		$.dialog({title:'<pg:message code="sany.pdp.dictmanager.data.gather.add"/>',width:300,height:270, content:'url:'+url});   	
	...
	function advance_EditDict(){
		...
		if(checkValue!=""){
			...
			$.dialog({title:'<pg:message code="sany.pdp.dictmanager.data.gather.modfiy"/>',width:300,height:270, content:'url:'+url});   	
	...
	function changeState_(flag){
	    ...
	    //0:不递归; 1:递归
	    var isRescure = "0";
	    var msg = '<pg:message code="sany.pdp.dictmanager.data.sub.recursion.disable"/>';
	    if(flag==1){//启用
	         msg = '<pg:message code="sany.pdp.dictmanager.data.sub.recursion.enable"/>'
	    }
	    if(flag==1){//启用 要提示
		    if(confirm(msg)){
		        isRescure = "1";
    ...
    function changeFlag(nFlag,condition){
		...
		//alert(num)
		for(var i = 1; i <= num; i ++ ){
			str += '<tr><th width="93px"><pg:message code="sany.pdp.dictmanager.data.advance"/>：</th><td width="270px"><select id="selectColumn'+i+'" name="highLevelColumn'+i+'"'
			...
			<div id="searchblock">
				<div  class="search_top">
	      		...
	      		<div class="search_box">
	      			<table width="97.8%" border="0" cellspacing="0" cellpadding="0">
	      				<tr>
		      						...
		      						<tr>
		      							<td colspan="4">
		      								...
		      								<table id="searchAdv" width="100%" border="0" cellpadding="0" cellspacing="0"  class="table2">
		      									<tr>
		      										<th width="93px"><pg:message code="sany.pdp.dictmanager.data.advance"/>：</th>
		      										<td width="270px">
