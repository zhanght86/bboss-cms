...
<div class="mcontent">
	...
	<form name="cacForm" action="saveModifyUserPWD.jsp" 
              ...
              <table width="100%" border="0"	cellpadding="0" cellspacing="0" class="table4">
              		<tr>
              			...
              			<td width="60%">
              				...
              				&nbsp;&nbsp;<a href="javascript:void(0)"  class="bt_2" onclick="openChoose()"><span><pg:message code="sany.pdp.personcenter.person.select"/></span></a>
              			</td>
              		</tr>
              		<tr>
              ...
              <div class="btnarea" >
				...
				<a href="javascript:void(0)"	class="bt_2"  name="label2"  onclick="resetpwd()"><span><pg:message code="sany.pdp.common.operation.cancel"/></span></a>
				<a href="javascript:void(0)"	class="bt_2"  name="label2"  onclick="randgen()"><span><pg:message code="sany.pdp.personcenter.person.password.generate"/></span></a>
			</div>	
     </form>
</div>
