...
<%@ page import="com.frameworkset.platform.comm.common.imp.*"%>
<%
  ...
  <tr>
    <td height="104" valign=middle><table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
        ...
        <td background="images/main_banner_right.gif"><div style=" float:left; width:auto;margin:10px; padding:4px;background-color:#7596BF;  font-size:12px;"><a href="javascript:void(0)" onClick="window.open('../sysmanager/user/userManager.do?method=getUserInfo','','width=750,height=600,resizable=no left=250 top=170');"><font style="color:#FFFFFF;"><strong>个人资料</strong></font></a></div>
              <div style=" float:left; width:auto;margin:10px; padding:4px;background-color:#7596BF;font-size:12px;"><a href="javascript:void(0)" onClick="window.open('../sysmanager/password/modifySelfPassword.jsp','','width=700,height=450,resizable=no left=250 top=170');"><font style="color:#FFFFFF;"><strong>个人密码修改</strong></font></a></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
