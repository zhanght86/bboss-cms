...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=request.getContextPath()%>/manageguide/js/manageguide-add.js">
		</script>
			...
			<form action="" method="post" id="add_manageguide_form"
				...
				<table width="100%" id="listtable" border="0" cellspacing="0"
					...
					<tr>
						...
						<td width="80%" class="input6" align="left"
							nowrap="nowrap">
							<s:textfield name="tdPwControlIndicators.controlName" cssClass="input6" cssStyle ="width:70%;">
							</s:textfield>
					...
					<tr>
						...
						<td width="40%" class="table_block_td" align="left"
							nowrap="nowrap">
							<s:textfield cssStyle ="width:70%;" cssClass="input6"
								name="tdPwControlIndicators.controlCode" >
							</s:textfield>
					...
					<tr>
						...
						<td width="3%" class="table_block_td" align="left" nowrap="nowrap">
							...
							<s:select name="tdPwControlIndicators.controlType"
								cssStyle ="width:70%;" cssClass="select4" id="getControType"
					...
					<tr>
						...
						<td width="3%" class="table_block_td" align="left" nowrap="nowrap">
							...
							<s:select name="tdPwControlIndicators.controlResType"
								cssStyle ="width:70%;"  cssClass="select4" id="getControResType"
								headerKey="-1" headerValue="-请选择-"
					...
					<tr>
						...
						<td width="3%" class="table_block_td" align="left" nowrap="nowrap">
							...
							<s:radio list="#statusType.statusType" value="'1'"
					...
					<tr>
						...
						<td width="3%" class="table_block_td" align="left" nowrap="nowrap">
							...
							<s:select name="tdPwControlIndicators.ruleId"
								 cssStyle ="width:70%;" cssClass="select4" id="getRuleContent"
								headerKey="-1" headerValue="-请选择-"
					...
					<tr>
						<td width="3%" class="c2" align="right" style="height:52px;" nowrap="nowrap">
							规则说明
						</td>
					...
					<tr>
						<td width="3%" colspan="2" align="center" nowrap="nowrap">
							<span style="text-align: center;"> <input type="button"
									name="addManageGuide" onclick="manageGuideAdd()" class="button"
