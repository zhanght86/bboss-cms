 ...
 * All right reserved.
 * 
 * 这个软件是属于三丄1�7重工股份有限公司机密的和私有信息，不得泄露�1�7�1�7
 * 并且只能由三丄1�7重工股份有限公司内部员工在得到许可的情况下才允许使用〄1�7
...
public class POIExcelUtil {
	 ...
	 * @param colDesc 形如＄1�7"工号:user_id,姓名:user_name,类型:type_name"
	 * @author gw_liaozh
	 */
	 ...
	 * @throws IllegalArgumentException 
	 */
	public static HSSFWorkbook createHSSFWorkbook(String colDesc, List<?> dataList) throws IllegalArgumentException,
	...
	private static HSSFFont getBaseFont(HSSFWorkbook wb) {//用到
	...
	private static CellStyle getDateTimeCellStyle(HSSFWorkbook wb) {//用到
	...
	private static HSSFCellStyle getHeadCellStyle(HSSFWorkbook wb, HSSFFont font) {//用到
