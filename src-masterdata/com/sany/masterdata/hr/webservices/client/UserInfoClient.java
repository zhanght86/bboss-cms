...
import com.sany.masterdata.hr.entity.userinfo.GetUserInfoList;
import com.sany.masterdata.hr.entity.userinfo.GetUserInfoListPortType;
import com.sany.masterdata.hr.entity.userinfo.ObjectFactory;
import com.sany.masterdata.hr.entity.userinfo.Parameter;
import com.sany.masterdata.utils.MDPropertiesUtil;

/**
 * human master data user info web services client
 * @author caix3
 * @since 2012-03-20
 */
public class UserInfoClient {

    private static final WebServiceProperties PROPERTIES = MDPropertiesUtil.getBean("hdmWebServicesUrlUser");
    ...
    private GetUserInfoListPortType port ;
    private void init() throws MalformedURLException
    {
    	if(port == null)
    	{
    		URL wsdlURL = null;
             ...
             GetUserInfoList services = new GetUserInfoList(wsdlURL, SERVICE_NAME);
             port = services.getGetUserInfoListHttpPort();
    	}
            
    }
    /**
     * call web services get human master data user list
     * @param stDate data onchange date start
     * @param enDate data onchange date en
     * @param low page start size
     * @param high page end size
     * @return ArrayOfUserInfo
     */
    public ArrayOfUserInfo getData(Date stDate, Date enDate, int low, int high) {

      
        ArrayOfUserInfo response = null;
        try {
            // create connection
          init();
            ...
            // call web services
            response = port.getUserList(parameter);
