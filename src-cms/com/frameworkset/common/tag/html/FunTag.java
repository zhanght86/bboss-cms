...
public class FunTag extends BaseTag implements Serializable{
	public int doStartTag() throws JspException{
		try{
			...
			buffer.append("var t_selectName,t_textfield,t_selecticon;\n");
			buffer.append("var t_type,t_datasource;\n");
			buffer.append("function keyup(selectName,textfield,selecticon,type,datasource){\n");
			buffer.append(" t_selectName = selectName;\n");
			buffer.append("t_textfield = textfield;\n");
			buffer.append("t_selecticon = selecticon;\n");
			...
			buffer.append("changestatus(selectName,textfield,selecticon);\n");
			...
			buffer.append("}\n");
			buffer.append("function keydown(selectName,textfield,selecticon)\n");
			buffer.append("{\n");
			buffer.append("t_selectName = selectName; \n");
			buffer.append(" t_textfield = textfield;\n");
			buffer.append(" t_selecticon = selecticon;\n");
			...
			buffer.append(" }\n");
			buffer.append("}\n");
			buffer.append("function changestatus(selectName,textfield,selecticon){\n");
			buffer.append("t_selectName = selectName;\n");
			buffer.append("t_textfield = textfield;\n");
			buffer.append(" t_selecticon = selecticon;\n");
			buffer.append(" document.all(t_selectName).style.display=\"block\";\n");
			buffer.append("}\n");
			buffer.append("function change(selectName,textfield,selecticon){\n");
			buffer.append(" t_selectName = selectName;\n");
			buffer.append("t_textfield = textfield;\n");
			buffer.append("t_selecticon = selecticon;\n");
			buffer.append("document.all(t_selectName).focus();\n");
			...
			buffer.append("if(eventName == t_selectName || eventName == t_textfield || eventName == t_selecticon)\n");
			buffer.append("return;\n");
