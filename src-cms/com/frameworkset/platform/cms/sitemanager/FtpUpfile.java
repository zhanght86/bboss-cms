...
public class FtpUpfile implements java.io.Serializable {
    ...
    public FtpUpfile(String ip, int port, String username, String password) throws
        ...
        localrootpath="d:\\ohh_cms\\pub";
        remoterootpath="/ohh_cms/pub";
    }
  ...
  public boolean testftp() throws Exception {
	...
	//	ftpclient.binary();
        ...
        ftpclient.sendServer("XMKD /_test_\r\n");
        ftpclient.sendServer("RMD /_test_\r\n");
    ...
    /**
     *目录上传
     *上传d:\ohh_cms\pub下的站点中的目录到ftp服务器对应的目录
     *在ftp服务器中建立/ohh_cms/pub目录
     *上传参数:\\sitea   
     */
