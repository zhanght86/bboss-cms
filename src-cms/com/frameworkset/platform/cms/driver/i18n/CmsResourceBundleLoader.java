 ...
 * @see com.frameworkset.platform.cms.driver.i18n.CmsResourceBundle
 * 
 ...
 * @since 6.2.0 
 */
public final class CmsResourceBundleLoader implements java.io.Serializable {
    ...
    private static CmsResourceBundle tryBundle(String localizedName) {
        ...
        try {
            ...
            if (url != null) {
                String path = FileUtil.normalizePath(url);
