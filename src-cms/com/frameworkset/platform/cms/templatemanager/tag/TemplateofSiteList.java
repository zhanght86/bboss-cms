...
public class TemplateofSiteList extends DataInfoImpl implements java.io.Serializable{
	...
	protected ListInfo getDataList(String sortKey, boolean desc, long offset,
		...
		if (siteId != null && siteId.length() > 0) { 
			try {
				...
				listInfo = templatemanagerM.getTemplateInfoListofSite(sql, (int)offset, maxPagesize);
