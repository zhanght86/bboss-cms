	...
	private boolean issueIframePlugin(int moduleCount,
		...
		for(int i = 0; i < moduleCount; i++){
			...
			liferay_portlet.append("\t<portlet>\n")
				...
				.append("\t\t<configuration-action-class>com.liferay.chinacreator.plugin.action.ConfigurationActionImpl</configuration-action-class>\n")
				.append("\t\t<instanceable>")
			...
			portlet.append("\t<portlet>\n")
				...
				.append("\t\t<portlet-class>com.liferay.chinacreator.plugin.portlet.IframeAppPortlet</portlet-class>\n")
				.append("\t\t<init-param>\n")
