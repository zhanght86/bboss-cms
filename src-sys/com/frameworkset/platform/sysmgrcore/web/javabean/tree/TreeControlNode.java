...
public class TreeControlNode implements Serializable {
    ...
    public TreeControlNode(String name, String icon, String label,
            String action, String target, boolean expanded) {
     ...
     *            removed
     */
    protected void removeChild(int offset) {
     ...
     */
    protected void removeChild(TreeControlNode child) {
    ...
    public void removeAllChild() {
        ...
        synchronized (children) {
            ...
            while (children.size() > 0) {
                TreeControlNode node = (TreeControlNode) children.get(children.size() - 1);
